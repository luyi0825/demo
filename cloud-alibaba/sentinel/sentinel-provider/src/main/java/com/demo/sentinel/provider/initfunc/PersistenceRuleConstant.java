package com.demo.sentinel.provider.initfunc;
...
public class PersistenceRuleConstant {
     ...
     * 存储文件路径
     */
    public static final String storePath = "F:\\workspace\\my\\demo\\cloud-alibaba\\sentinel\\sentinel-provider\\src\\main\\resources\\sentinel"  + File.separator + "rules";
